...
namespace Intar1991.Tests {
    public class MatrixTest {
        ...
        static double Delta(UnityEngine.Matrix4x4 e, Matrix3x3I2F30 a) {
            var d = 0.0;
            ...
            d = Math.Max(d, Math.Abs(e.m03 - 0.0));
            ...
            d = Math.Max(d, Math.Abs(e.m13 - 0.0));
            ...
            d = Math.Max(d, Math.Abs(e.m23 - 0.0));
            d = Math.Max(d, Math.Abs(e.m30 - 0.0));
            d = Math.Max(d, Math.Abs(e.m31 - 0.0));
            d = Math.Max(d, Math.Abs(e.m32 - 0.0));
        ...
        static double Delta(Unity.Mathematics.float3x3 e, Matrix3x3I2F30 a) {
            var d = 0.0;
