...
#pragma warning restore IDE0079
        ...
        /// </example>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U17F15 StrictLossyFrom(float num) {
        ...
        public static U17F15? CheckedFrom(double num) {
            // OneRepr は 2 の自然数冪であるから、
            // その乗算によって精度が失われることは
            // 基数 (Radix) が 2 の自然数冪でない限りない。
            // また、整数の基数は 2 であるから、
        ...
        /// Basic usage:
        /// <code>
        /// var a = U17F15.StrictFrom(1.0);
        /// System.Assert.AreEqual(1 &lt;&lt; 15, a.Bits);
        /// </code>
        /// </example>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U17F15 StrictFrom(double num) {
            // OneRepr は 2 の自然数冪であるから、
            // その乗算および型変換によって精度が失われることは
            // 基数 (Radix) が 2 の自然数冪でない限りない。
            return FromBits(checked((uint)(num * OneRepr)));
