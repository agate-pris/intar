...
#pragma warning disable IDE0004 // 不要なキャストの削除
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I17F15 StrictLossyToI17F15() => I17F15.FromBits(checked((int)(Bits / (1UL << 16))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I2F30 StrictLossyToI2F30() => I2F30.FromBits(checked((int)(Bits / (1UL << 1))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I34F30 LossyToI34F30() => I34F30.FromBits((long)(Bits / (1UL << 1)));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I33F31 StrictToI33F31() => I33F31.FromBits(checked((long)Bits * (1L << 0)));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U17F15 StrictLossyToU17F15() => U17F15.FromBits(checked((uint)(Bits / (1UL << 16))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U2F30 StrictLossyToU2F30() => U2F30.FromBits(checked((uint)(Bits / (1UL << 1))));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U34F30 LossyToU34F30() => U34F30.FromBits((ulong)(Bits / (1UL << 1)));
        ...
        public I17F15? CheckedLossyToI17F15() {
            ...
            // 自身が符号なしで、相手が符号ありの場合、
            // 自身が相手の最大値よりも大きければ null
            if (tmp > (uint)I17F15.MaxValue.Bits) {
                return null;
            }
        ...
        public I33F31? CheckedToI33F31() {
            if (Bits > (ulong)I33F31.MaxValue.Bits / (1L << 0)) {
                return null;
            }

            return I33F31.FromBits((long)Bits * (1L << 0));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I4F60? CheckedToI4F60() {
            if (Bits > (ulong)I4F60.MaxValue.Bits / (1L << 29)) {
                return null;
            }
        ...
        public I2F62? CheckedToI2F62() {
            if (Bits > (ulong)I2F62.MaxValue.Bits / (1L << 31)) {
                return null;
            }
        ...
        public U17F15? CheckedLossyToU17F15() {
            ...
            // 自身と相手の符号が同じ場合、
            // 暗黙に大きい方の型にキャストされる。
            if (tmp < U17F15.MinValue.Bits ||
                tmp > U17F15.MaxValue.Bits) {
                return null;
            }
        ...
        public U4F60? CheckedToU4F60() {
            if (Bits > U4F60.MaxValue.Bits / (1UL << 29) ||
                Bits < U4F60.MinValue.Bits / (1UL << 29)) {
                return null;
            }
        ...
        public U2F62? CheckedToU2F62() {
            if (Bits > U2F62.MaxValue.Bits / (1UL << 31) ||
                Bits < U2F62.MinValue.Bits / (1UL << 31)) {
                return null;
            }
