...
namespace AgatePris.Intar.Mathematics {
    [Serializable]
    public struct U2F30_2 : IEquatable<U2F30_2>, IFormattable {
        // Fields
        // ---------------------------------------
        ...
        public static readonly U2F30_2 zero;

        // Constructors
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U2F30_2(U2F30 x, U2F30 y) {
            this.x = x;
            this.y = y;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U2F30_2(U2F30_2 xy) {
            x = xy.x;
            y = xy.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U2F30_2 operator +(U2F30_2 a, U2F30_2 b) => new U2F30_2(
            a.x + b.x,
            a.y + b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U2F30_2 operator *(U2F30_2 a, U2F30 b) => new U2F30_2(
            a.x * b,
            a.y * b);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U2F30_2 operator *(U2F30 a, U2F30_2 b) => new U2F30_2(
            a * b.x,
            a * b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(U2F30_2 lhs, U2F30_2 rhs) => lhs.Equals(rhs);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator !=(U2F30_2 lhs, U2F30_2 rhs) => !(lhs == rhs);

        // Object
        // ---------------------------------------

        public override readonly bool Equals(object obj) => obj is U2F30_2 o && Equals(o);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly int GetHashCode() => HashCode.Combine(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"U2F30_2({x}, {y})";

        // IEquatable<U2F30_2>
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(U2F30_2 other)
            => other.x == x
            && other.y == y;
