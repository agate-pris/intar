...
namespace AgatePris.Intar.Mathematics {
    [Serializable]
    public struct I26F6_2 : IEquatable<I26F6_2>, IFormattable {
        // Fields
        // ---------------------------------------
        ...
        public static readonly I26F6_2 zero;

        // Constructors
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I26F6_2(I26F6 x, I26F6 y) {
            this.x = x;
            this.y = y;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I26F6_2(I26F6_2 xy) {
            x = xy.x;
            y = xy.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_2 operator +(I26F6_2 a, I26F6_2 b) => new I26F6_2(
            a.x + b.x,
            a.y + b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_2 operator *(I26F6_2 a, I26F6 b) => new I26F6_2(
            a.x * b,
            a.y * b);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_2 operator *(I26F6 a, I26F6_2 b) => new I26F6_2(
            a * b.x,
            a * b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(I26F6_2 lhs, I26F6_2 rhs) => lhs.Equals(rhs);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator !=(I26F6_2 lhs, I26F6_2 rhs) => !(lhs == rhs);

        // Object
        // ---------------------------------------

        public override readonly bool Equals(object obj) => obj is I26F6_2 o && Equals(o);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly int GetHashCode() => HashCode.Combine(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"I26F6_2({x}, {y})";

        // IEquatable<I26F6_2>
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(I26F6_2 other)
            => other.x == x
            && other.y == y;
    ...
    public static partial class math {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_2 I26F6_2(I26F6 x, I26F6 y) => new I26F6_2(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_2 I26F6_2(I26F6_2 xy) => new I26F6_2(xy);
    }
}
