...
namespace AgatePris.Intar.Mathematics {
    ...
    public struct int3 : IEquatable<int3>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 operator +(int3 a, int3 b) => new int3(
            a.x + b.x,
            a.y + b.y,
            a.z + b.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 operator *(int3 a, int b) => new int3(
            a.x * b,
            a.y * b,
            a.z * b);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 operator *(int a, int3 b) => new int3(
            a * b.x,
            a * b.y,
            a * b.z);
        ...
        public override readonly bool Equals(object obj) => obj is int3 o && Equals(o);
    ...
    public static partial class math {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 int3(int x, int2 yz) => new int3(x, yz);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 int3(int3 xyz) => new int3(xyz);
