...
namespace AgatePris.Intar.Mathematics {
    [Serializable]
    public struct I26F6_3 : IEquatable<I26F6_3>, IFormattable {
        // Fields
        // ---------------------------------------
        ...
        public static readonly I26F6_3 zero;

        // Constructors
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I26F6_3(I26F6 x, I26F6 y, I26F6 z) {
            this.x = x;
            this.y = y;
            this.z = z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I26F6_3(I26F6 x, I26F6_2 yz) {
            this.x = x;
            y = yz.x;
            z = yz.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I26F6_3(I26F6_2 xy, I26F6 z) {
            x = xy.x;
            y = xy.y;
            this.z = z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_3 operator +(I26F6_3 a, I26F6_3 b) => new I26F6_3(
            a.x + b.x,
            a.y + b.y,
            a.z + b.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_3 operator *(I26F6_3 a, I26F6 b) => new I26F6_3(
            a.x * b,
            a.y * b,
            a.z * b);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_3 operator *(I26F6 a, I26F6_3 b) => new I26F6_3(
            a * b.x,
            a * b.y,
            a * b.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(I26F6_3 lhs, I26F6_3 rhs) => lhs.Equals(rhs);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator !=(I26F6_3 lhs, I26F6_3 rhs) => !(lhs == rhs);

        // Object
        // ---------------------------------------

        public override readonly bool Equals(object obj) => obj is I26F6_3 o && Equals(o);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly int GetHashCode() => HashCode.Combine(x, y, z);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"I26F6_3({x}, {y}, {z})";

        // IEquatable<I26F6_3>
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(I26F6_3 other)
            => other.x == x
            && other.y == y
            && other.z == z;
        ...
        public readonly string ToString(string format, IFormatProvider formatProvider) {
            ...
            return $"I26F6_3({x}, {y}, {z})";
        }
    }

    public static partial class math {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_3 I26F6_3(I26F6 x, I26F6 y, I26F6 z) => new I26F6_3(x, y, z);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_3 I26F6_3(I26F6 x, I26F6_2 yz) => new I26F6_3(x, yz);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_3 I26F6_3(I26F6_3 xyz) => new I26F6_3(xyz);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I26F6_3 I26F6_3(I26F6_2 xy, I26F6 z) => new I26F6_3(xy, z);
    }
}
