...
namespace AgatePris.Intar.Mathematics {
    [Serializable]
    public struct I12F20_2 : IEquatable<I12F20_2>, IFormattable {
        // Fields
        // ---------------------------------------
        ...
        public static readonly I12F20_2 zero;

        // Constructors
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I12F20_2(I12F20 x, I12F20 y) {
            this.x = x;
            this.y = y;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I12F20_2(I12F20_2 xy) {
            x = xy.x;
            y = xy.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I12F20_2 operator +(I12F20_2 a, I12F20_2 b) => new I12F20_2(
            a.x + b.x,
            a.y + b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I12F20_2 operator *(I12F20_2 a, I12F20 b) => new I12F20_2(
            a.x * b,
            a.y * b);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I12F20_2 operator *(I12F20 a, I12F20_2 b) => new I12F20_2(
            a * b.x,
            a * b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(I12F20_2 lhs, I12F20_2 rhs) => lhs.Equals(rhs);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator !=(I12F20_2 lhs, I12F20_2 rhs) => !(lhs == rhs);

        // Object
        // ---------------------------------------

        public override readonly bool Equals(object obj) => obj is I12F20_2 o && Equals(o);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly int GetHashCode() => HashCode.Combine(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"I12F20_2({x}, {y})";

        // IEquatable<I12F20_2>
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(I12F20_2 other)
            => other.x == x
            && other.y == y;
    ...
    public static partial class math {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I12F20_2 I12F20_2(I12F20 x, I12F20 y) => new I12F20_2(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I12F20_2 I12F20_2(I12F20_2 xy) => new I12F20_2(xy);
    }
}
