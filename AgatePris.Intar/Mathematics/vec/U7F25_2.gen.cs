...
namespace AgatePris.Intar.Mathematics {
    [Serializable]
    public struct U7F25_2 : IEquatable<U7F25_2>, IFormattable {
        // Fields
        // ---------------------------------------
        ...
        public static readonly U7F25_2 zero;

        // Constructors
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U7F25_2(U7F25 x, U7F25 y) {
            this.x = x;
            this.y = y;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U7F25_2(U7F25_2 xy) {
            x = xy.x;
            y = xy.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U7F25_2 operator +(U7F25_2 a, U7F25_2 b) => new U7F25_2(
            a.x + b.x,
            a.y + b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U7F25_2 operator *(U7F25_2 a, U7F25 b) => new U7F25_2(
            a.x * b,
            a.y * b);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U7F25_2 operator *(U7F25 a, U7F25_2 b) => new U7F25_2(
            a * b.x,
            a * b.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(U7F25_2 lhs, U7F25_2 rhs) => lhs.Equals(rhs);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator !=(U7F25_2 lhs, U7F25_2 rhs) => !(lhs == rhs);

        // Object
        // ---------------------------------------

        public override readonly bool Equals(object obj) => obj is U7F25_2 o && Equals(o);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly int GetHashCode() => HashCode.Combine(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"U7F25_2({x}, {y})";

        // IEquatable<U7F25_2>
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(U7F25_2 other)
            => other.x == x
            && other.y == y;
    ...
    public static partial class math {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U7F25_2 U7F25_2(U7F25 x, U7F25 y) => new U7F25_2(x, y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U7F25_2 U7F25_2(U7F25_2 xy) => new U7F25_2(xy);
    }
}
