...
#pragma warning disable IDE0004 // 不要なキャストの削除
        ...
        public static I2F30 StrictFrom(I17F15 from) {
            return FromBits(checked((int)from.Bits * ((int)1 << 15)));
        }
        ...
        public static I2F30? CheckedFrom(I17F15 from) {
            if (from.Bits > (MaxRepr / ((int)1 << 15)) ||
                from.Bits < (MinRepr / ((int)1 << 15))) {
                return null;
            }
        ...
        public static I2F30? CheckedFrom(I34F30 from) {
            if (from.Bits > (MaxRepr / ((int)1 << 0)) ||
                from.Bits < (MinRepr / ((int)1 << 0))) {
                return null;
            }
        ...
        public static I2F30 StrictLossyFrom(I33F31 from) {
            return FromBits(checked((int)(from.Bits / ((long)1 << 1))));
        }
        ...
        public static I2F30 StrictLossyFrom(I4F60 from) {
            return FromBits(checked((int)(from.Bits / ((long)1 << 30))));
        }
        ...
        public static I2F30 LossyFrom(I2F62 from) {
            return FromBits((int)(from.Bits / ((long)1 << 32)));
        }
        ...
        public static I2F30? CheckedFrom(U17F15 from) {
            if (from.Bits > (uint)(MaxRepr / ((int)1 << 15))) {
                return null;
            }
            return FromBits((int)from.Bits * ((int)1 << 15));
        }
        ...
        public static I2F30 StrictLossyFrom(U33F31 from) {
            return FromBits(checked((int)(from.Bits / ((ulong)1 << 1))));
        }
        ...
        public static I2F30 StrictLossyFrom(U4F60 from) {
            return FromBits(checked((int)(from.Bits / ((ulong)1 << 30))));
        }
        ...
        public static I2F30 StrictLossyFrom(U2F62 from) {
            return FromBits(checked((int)(from.Bits / ((ulong)1 << 32))));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I17F15 LossyToI17F15() => I17F15.FromBits((int)(Bits / (1 << 15)));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I2F62 ToI2F62() => I2F62.FromBits((long)Bits * (1L << 32));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U17F15 StrictLossyToU17F15() => U17F15.FromBits(checked((uint)(Bits / (1 << 15))));
        ...
        public U17F15? CheckedLossyToU17F15() {
            ...
            if (tmp < 0) {
                return null;
            } else if ((uint)tmp > U17F15.MaxValue.Bits) {
                return null;
            }
        ...
        public U2F30? CheckedToU2F30() {
            if (Bits < 0) {
                return null;
            } else if ((uint)Bits > U2F30.MaxValue.Bits / (1U << 0)) {
                return null;
            }
        ...
        public U34F30? CheckedToU34F30() {
            if (Bits < 0) {
                return null;
            } else if ((uint)Bits > U34F30.MaxValue.Bits / (1UL << 0)) {
                return null;
            }
        ...
        public U33F31? CheckedToU33F31() {
            if (Bits < 0) {
                return null;
            } else if ((uint)Bits > U33F31.MaxValue.Bits / (1UL << 1)) {
                return null;
            }
        ...
        public U4F60? CheckedToU4F60() {
            if (Bits < 0) {
                return null;
            } else if ((uint)Bits > U4F60.MaxValue.Bits / (1UL << 30)) {
                return null;
            }
        ...
        public U2F62? CheckedToU2F62() {
            if (Bits < 0) {
                return null;
            } else if ((uint)Bits > U2F62.MaxValue.Bits / (1UL << 32)) {
                return null;
            }
