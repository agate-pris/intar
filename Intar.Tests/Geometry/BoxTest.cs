...
namespace Intar.Tests.Geometry {
    public class BoxTest {
        ...
        public static void TestPoint() {
            ...
            // Box2I17F15.Intersects(Vector2I17F15),
            // Box2I17F15.Overlaps(Vector2I17F15) は常に false を返す.

            // ((1, 1), (-1, 1), (-1, -1), (1, -1))
            {
                var b = new Box2I17F15(
                    Vector2I17F15.Zero, Vector2I17F15.One
                );
                Assert.IsTrue(b.Intersects(Vector2I17F15.Zero));
                Assert.IsTrue(b.Intersects(Vector2I17F15.UnitX));
                Assert.IsTrue(b.Intersects(Vector2I17F15.UnitY));
                Assert.IsTrue(b.Intersects(Vector2I17F15.One));
                Assert.IsTrue(b.Overlaps(Vector2I17F15.Zero));
                Assert.IsFalse(b.Overlaps(Vector2I17F15.UnitX));
                Assert.IsFalse(b.Overlaps(Vector2I17F15.UnitY));
                Assert.IsFalse(b.Overlaps(Vector2I17F15.One));
            }
