...
namespace Intar.Tests {
    public class I33F31Test {
        ...
        static void TestAtan2P2(long y, long x) {
            ...
            var negativeY = -y;
            var negativeX = -x;
            var a = I33F31.Atan2P2(y, x);
            var b = I33F31.Atan2P2(x, y);
            var c = I33F31.Atan2P2(x, negativeY);
            var d = I33F31.Atan2P2(y, negativeX);
            var e = I33F31.Atan2P2(negativeY, negativeX);
            var f = I33F31.Atan2P2(negativeX, negativeY);
            var g = I33F31.Atan2P2(negativeX, y);
            var h = I33F31.Atan2P2(negativeY, x);
            ...
            const long straight = I33F31.OneRepr * 2;
            if (I33F31.OneRepr - a.Bits != b.Bits) {
                Assert.AreEqual(I33F31.OneRepr - a.Bits, b.Bits, $"y:{y} x:{x}");
            }
            if (I33F31.OneRepr + a.Bits != c.Bits) {
                Assert.AreEqual(I33F31.OneRepr + a.Bits, c.Bits, $"y:{y} x:{x}");
            }
            ...
            if (I33F31.NegativeOneRepr - a.Bits != f.Bits) {
                Assert.AreEqual(I33F31.NegativeOneRepr - a.Bits, f.Bits, $"y:{y} x:{x}");
            }
            if (I33F31.NegativeOneRepr + a.Bits != g.Bits) {
                Assert.AreEqual(I33F31.NegativeOneRepr + a.Bits, g.Bits, $"y:{y} x:{x}");
            }
            if (-a.Bits != h.Bits) {
        ...
        public void TestAtan2P2() {
            {
                var a = I33F31.Atan2P2(0, 0);
                var b = I33F31.Atan2P2(0, 1);
                var c = I33F31.Atan2P2(1, 0);
                var d = I33F31.Atan2P2(1, 1);
                var e = I33F31.Atan2P2(0, -1);
                var f = I33F31.Atan2P2(1, -1);
                var g = I33F31.Atan2P2(-1, 0);
                var h = I33F31.Atan2P2(-1, 1);
                var i = I33F31.Atan2P2(-1, -1);
                Assert.AreEqual(I33F31.Zero, a);
                Assert.AreEqual(I33F31.Zero, b);
                Assert.AreEqual(I33F31.One, c);
                Assert.AreEqual(I33F31.OneRepr / 2, d.Bits);
                Assert.AreEqual(I33F31.OneRepr * 2, e.Bits);
                Assert.AreEqual(I33F31.OneRepr / 2 * 3, f.Bits);
                Assert.AreEqual(I33F31.NegativeOne, g);
                Assert.AreEqual(I33F31.NegativeOneRepr / 2, h.Bits);
                Assert.AreEqual(I33F31.NegativeOneRepr / 2 * 3, i.Bits);
            }
        ...
        static void TestAtan2P3(long y, long x) {
            ...
            var negativeY = -y;
            var negativeX = -x;
            var a = I33F31.Atan2P3(y, x);
            var b = I33F31.Atan2P3(x, y);
            var c = I33F31.Atan2P3(x, negativeY);
            var d = I33F31.Atan2P3(y, negativeX);
            var e = I33F31.Atan2P3(negativeY, negativeX);
            var f = I33F31.Atan2P3(negativeX, negativeY);
            var g = I33F31.Atan2P3(negativeX, y);
            var h = I33F31.Atan2P3(negativeY, x);
            const double delta = 4e-3;
            Utility.AssertAreEqual(Math.Atan2(y, x), (double)a * scale, delta);
            Utility.AssertAreEqual(Math.Atan2(x, y), (double)b * scale, delta);
            Utility.AssertAreEqual(Math.Atan2(x, negativeY), (double)c * scale, delta);
        ...
        public void TestAtan2P3() {
            {
                var a = I33F31.Atan2P3(0, 0);
                var b = I33F31.Atan2P3(0, 1);
                var c = I33F31.Atan2P3(1, 0);
                var d = I33F31.Atan2P3(1, 1);
                var e = I33F31.Atan2P3(0, -1);
                var f = I33F31.Atan2P3(1, -1);
                var g = I33F31.Atan2P3(-1, 0);
                var h = I33F31.Atan2P3(-1, 1);
                var i = I33F31.Atan2P3(-1, -1);
                Assert.AreEqual(I33F31.Zero, a);
                Assert.AreEqual(I33F31.Zero, b);
                Assert.AreEqual(I33F31.One, c);
                Assert.AreEqual(I33F31.OneRepr / 2, d.Bits);
        ...
        static void TestAtan2P9(long y, long x) {
            ...
            var negativeY = -y;
            var negativeX = -x;
            var a = I33F31.Atan2P9(y, x);
            var b = I33F31.Atan2P9(x, y);
            var c = I33F31.Atan2P9(x, negativeY);
            var d = I33F31.Atan2P9(y, negativeX);
            var e = I33F31.Atan2P9(negativeY, negativeX);
            var f = I33F31.Atan2P9(negativeX, negativeY);
            var g = I33F31.Atan2P9(negativeX, y);
            var h = I33F31.Atan2P9(negativeY, x);
            const double delta = 4e-3;
            Utility.AssertAreEqual(Math.Atan2(y, x), (double)a * scale, delta);
            Utility.AssertAreEqual(Math.Atan2(x, y), (double)b * scale, delta);
            Utility.AssertAreEqual(Math.Atan2(x, negativeY), (double)c * scale, delta);
        ...
        [Test]
        public void TestAtan2P9() {
            {
                var a = I33F31.Atan2P9(0, 0);
                var b = I33F31.Atan2P9(0, 1);
                var c = I33F31.Atan2P9(1, 0);
                var d = I33F31.Atan2P9(1, 1);
                var e = I33F31.Atan2P9(0, -1);
                var f = I33F31.Atan2P9(1, -1);
                var g = I33F31.Atan2P9(-1, 0);
                var h = I33F31.Atan2P9(-1, 1);
                var i = I33F31.Atan2P9(-1, -1);
                Assert.AreEqual(I33F31.Zero, a);
                Assert.AreEqual(I33F31.Zero, b);
                Assert.AreEqual(I33F31.One, c);
                Assert.AreEqual(I33F31.OneRepr / 2, d.Bits);
