...
namespace Intar.Tests.Mathi {
    public class SinTest {
        ...
        public static void TestSinP3() {
            var expectedSin = new int[] {
                0, 49151, 98302, 147453, 196604, 245755, 294906, 344057, 393208, 442359,
                491510, 540661, 589812, 638963, 688114, 737265, 786416, 835567, 884718,
                933869, 983020, 1032171, 1081322, 1130473, 1179624, 1228775,
            };
            var expectedCos = new int[] {
                1073741824, 1073709056, 1073709054, 1073709050, 1073709044, 1073709036,
                1073709026, 1073709014, 1073709000, 1073708984, 1073708966, 1073708946,
                1073708924, 1073708900, 1073708874, 1073708846, 1073708816, 1073708784,
                1073708750, 1073708714,
            };
        ...
        public static void TestSinP3L() {
            var expectedSin = new long[] {
                0, 3221225471, 6442450942, 9663676413, 12884901884, 16106127355, 19327352826,
                22548578297, 25769803768, 28991029239, 32212254710, 35433480181, 38654705652,
                41875931123, 45097156594, 48318382065, 51539607536, 54760833007, 57982058478,
                61203283949, 64424509420, 67645734891, 70866960362, 74088185833, 77309411304,
                80530636775, 83751862246, 86973087717, 90194313188, 93415538659, 96636764130,
                99857989601, 103079215072,
            };
            var expectedCos = new long[] {
                4611686018427387904, 4611686016279904256, 4611686016279904254, 4611686016279904250,
                4611686016279904244, 4611686016279904236, 4611686016279904226, 4611686016279904214,
                4611686016279904200, 4611686016279904184, 4611686016279904166, 4611686016279904146,
            };
            TestSin(expectedSin, expectedCos, Intar.Mathi.SinP3, Intar.Mathi.CosP3, 0.03);
        }
        [Test]
