...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U2F30 Min(Vector3U2F30 other) => new Vector3U2F30(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U2F30 Max(Vector3U2F30 other) => new Vector3U2F30(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U2F30 WrappingAdd(Vector3U2F30 other) => new Vector3U2F30(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U2F30 WrappingSub(Vector3U2F30 other) => new Vector3U2F30(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U2F30 WrappingMul(Vector3U2F30 other) => new Vector3U2F30(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U2F30 WrappingAddSigned(Vector3I2F30 other) => new Vector3U2F30(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector3U2F30 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U2F30 SaturatingDot(Vector3U2F30 other) {
            const ulong k = 1UL << 28;
