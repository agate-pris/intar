...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U28F4 Cross(Vector3U28F4 other) {
            const ulong k = 1UL << 4;
            var ax = (ulong)X.Bits;
            var ay = (ulong)Y.Bits;
            var az = (ulong)Z.Bits;
            ...
            return new Vector3U28F4(
                U28F4.FromBits((uint)(x / k)),
                U28F4.FromBits((uint)(y / k)),
                U28F4.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U58F6 WideningDot(Vector3U28F4 other) {
            ...
            var bits =
                ...
                (y.Bits / 4) +
                (z.Bits / 4);
            return U58F6.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U28F4 Dot(Vector3U28F4 other) => (U28F4)WideningDot(other);
