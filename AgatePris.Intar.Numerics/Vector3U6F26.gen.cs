...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U6F26 Cross(Vector3U6F26 other) {
            ...
            return new Vector3U6F26(
                U6F26.FromBits((uint)(x / k)),
                U6F26.FromBits((uint)(y / k)),
                U6F26.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U14F50 WideningDot(Vector3U6F26 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U6F26 Dot(Vector3U6F26 other) => (U6F26)WideningDot(other);
