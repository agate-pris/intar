...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public readonly Vector2I31F1 Half() => new Vector2I31F1(
            X.Half(),
            Y.Half());

        public readonly Vector2I31F1 Twice() => new Vector2I31F1(
            X.Twice(),
            Y.Twice());

        public readonly Vector2I31F1 Clamp(I31F1 min, I31F1 max) => new Vector2I31F1(
            X.Clamp(min, max),
            Y.Clamp(min, max));

        public readonly Vector2I31F1 Clamp(
            Vector2I31F1 min, Vector2I31F1 max
        ) => new Vector2I31F1(
            X.Clamp(min.X, max.X),
            Y.Clamp(min.Y, max.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I31F1 SaturatingAdd(Vector2I31F1 other) => new Vector2I31F1(
            X.SaturatingAdd(other.X),
            Y.SaturatingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I31F1 SaturatingMul(I31F1 other) => new Vector2I31F1(
            X.SaturatingMul(other),
            Y.SaturatingMul(other));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I31F1 Dot(Vector2I31F1 other) {
            return
                X * other.X +
                Y * other.Y;
        }
    ...
    partial struct I31F1 {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I31F1 SaturatingMul(Vector2I31F1 other) => other.SaturatingMul(this);
    }
}
