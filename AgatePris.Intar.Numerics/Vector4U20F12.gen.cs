...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U42F22 WideningDot(Vector4U20F12 other) {
            ...
            var bits =
                ...
                (z.Bits / 4) +
                (w.Bits / 4);
            return U42F22.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U20F12 Dot(Vector4U20F12 other) => (U20F12)WideningDot(other);
