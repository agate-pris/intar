...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U20F12 Cross(Vector3U20F12 other) {
            ...
            return new Vector3U20F12(
                U20F12.FromBits((uint)(x / k)),
                U20F12.FromBits((uint)(y / k)),
                U20F12.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U42F22 WideningDot(Vector3U20F12 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U20F12 Dot(Vector3U20F12 other) => (U20F12)WideningDot(other);
