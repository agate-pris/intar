...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U16F16 Min(Vector3U16F16 other) => new Vector3U16F16(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U16F16 Max(Vector3U16F16 other) => new Vector3U16F16(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U16F16 WrappingAdd(Vector3U16F16 other) => new Vector3U16F16(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U16F16 WrappingSub(Vector3U16F16 other) => new Vector3U16F16(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U16F16 WrappingMul(Vector3U16F16 other) => new Vector3U16F16(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U16F16 WrappingAddSigned(Vector3I16F16 other) => new Vector3U16F16(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector3U16F16 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U16F16 SaturatingDot(Vector3U16F16 other) {
            const ulong k = 1UL << 14;
