...
namespace AgatePris.Intar.Numerics {
    [Serializable]
    public partial struct U45F19 : IEquatable<U45F19>, IFormattable {
        // Consts
        // ------
...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public override bool Equals(object obj) => obj is U45F19 o && Equals(o);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(U45F19 other) => Bits == other.Bits;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 Min(U45F19 other) => FromBits(Math.Min(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 Max(U45F19 other) => FromBits(Math.Max(Bits, other.Bits));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 Half() => FromBits(Mathi.Half(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 Twice() => FromBits(Mathi.Twice(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 WrappingAdd(U45F19 other) => FromBits(Overflowing.WrappingAdd(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 WrappingSub(U45F19 other) => FromBits(Overflowing.WrappingSub(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 WrappingMul(U45F19 other) => FromBits(Overflowing.WrappingMul(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 WrappingAddSigned(I45F19 other) => FromBits(Overflowing.WrappingAddSigned(Bits, other.Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U45F19 LosslessMul(ulong other) => FromBits(Bits * other);
