...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public static readonly Vector3I10F22 zero;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I10F22(I10F22 x, Vector2I10F22 yz) {
            X = x;
            Y = yz.X;
            Z = yz.Y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I10F22(Vector3I10F22 xyz) {
            X = xyz.X;
            Y = xyz.Y;
            Z = xyz.Z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I10F22(Vector2I10F22 xy, I10F22 z) {
            X = xy.X;
            Y = xy.Y;
            Z = z;
        }
