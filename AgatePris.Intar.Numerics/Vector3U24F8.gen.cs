...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 Min(Vector3U24F8 other) => new Vector3U24F8(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 Max(Vector3U24F8 other) => new Vector3U24F8(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 Half() => new Vector3U24F8(
            X.Half(),
            Y.Half(),
            Z.Half());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 Twice() => new Vector3U24F8(
            X.Twice(),
            Y.Twice(),
            Z.Twice());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 Clamp(U24F8 min, U24F8 max) => new Vector3U24F8(
            X.Clamp(min, max),
            Y.Clamp(min, max),
            Z.Clamp(min, max));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 Clamp(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 WrappingAdd(Vector3U24F8 other) => new Vector3U24F8(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 WrappingSub(Vector3U24F8 other) => new Vector3U24F8(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 WrappingMul(Vector3U24F8 other) => new Vector3U24F8(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 WrappingAddSigned(Vector3I24F8 other) => new Vector3U24F8(
            X.WrappingAddSigned(other.X),
            Y.WrappingAddSigned(other.Y),
            Z.WrappingAddSigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 SaturatingAdd(Vector3U24F8 other) => new Vector3U24F8(
            X.SaturatingAdd(other.X),
            Y.SaturatingAdd(other.Y),
            Z.SaturatingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 SaturatingMul(U24F8 other) => new Vector3U24F8(
            X.SaturatingMul(other),
            Y.SaturatingMul(other),
            Z.SaturatingMul(other));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector3U24F8 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U24F8 Dot(Vector3U24F8 other) {
            const ulong k = 1UL << 6;
            return U24F8.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U24F8 SaturatingDot(Vector3U24F8 other) {
            const ulong k = 1UL << 6;
    ...
    partial struct U24F8 {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 SaturatingMul(Vector3U24F8 other) => other.SaturatingMul(this);
    }
}
