...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U24F8 Cross(Vector3U24F8 other) {
            const ulong k = 1UL << 8;
            var ax = (ulong)X.Bits;
            var ay = (ulong)Y.Bits;
            var az = (ulong)Z.Bits;
            ...
            return new Vector3U24F8(
                U24F8.FromBits((uint)(x / k)),
                U24F8.FromBits((uint)(y / k)),
                U24F8.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U50F14 WideningDot(Vector3U24F8 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U24F8 Dot(Vector3U24F8 other) => (U24F8)WideningDot(other);
