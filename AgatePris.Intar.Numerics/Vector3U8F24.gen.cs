...
namespace AgatePris.Intar.Mathematics {
    ...
    public struct Vector3U8F24 : IEquatable<Vector3U8F24>, IFormattable {
        ...
        public static readonly Vector3U8F24 zero;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U8F24(U8F24 x, Vector2U8F24 yz) {
            this.x = x;
            y = yz.x;
            z = yz.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U8F24(Vector3U8F24 xyz) {
            x = xyz.x;
            y = xyz.y;
            z = xyz.z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U8F24(Vector2U8F24 xy, U8F24 z) {
            x = xy.x;
            y = xy.y;
            this.z = z;
        }
...
#pragma warning restore IDE1006 // 命名スタイル
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"Vector3U8F24({x}, {y}, {z})";
