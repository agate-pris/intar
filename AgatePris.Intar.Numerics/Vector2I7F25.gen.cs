...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 Min(Vector2I7F25 other) => new Vector2I7F25(
            X.Min(other.X),
            Y.Min(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 Max(Vector2I7F25 other) => new Vector2I7F25(
            X.Max(other.X),
            Y.Max(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 Abs() => new Vector2I7F25(
            X.Abs(),
            Y.Abs());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 Half() => new Vector2I7F25(
            X.Half(),
            Y.Half());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 Twice() => new Vector2I7F25(
            X.Twice(),
            Y.Twice());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 Clamp(I7F25 min, I7F25 max) => new Vector2I7F25(
            X.Clamp(min, max),
            Y.Clamp(min, max));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 Clamp(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 WrappingAdd(Vector2I7F25 other) => new Vector2I7F25(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 WrappingSub(Vector2I7F25 other) => new Vector2I7F25(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 WrappingMul(Vector2I7F25 other) => new Vector2I7F25(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 WrappingAddUnsigned(Vector2U7F25 other) => new Vector2I7F25(
            X.WrappingAddUnsigned(other.X),
            Y.WrappingAddUnsigned(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 WrappingSubUnsigned(Vector2U7F25 other) => new Vector2I7F25(
            X.WrappingSubUnsigned(other.X),
            Y.WrappingSubUnsigned(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U7F25 UnsignedAbs() => new Vector2U7F25(
            X.UnsignedAbs(),
            Y.UnsignedAbs());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 SaturatingAdd(Vector2I7F25 other) => new Vector2I7F25(
            X.SaturatingAdd(other.X),
            Y.SaturatingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 SaturatingMul(I7F25 other) => new Vector2I7F25(
            X.SaturatingMul(other),
            Y.SaturatingMul(other));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly long DotInternal(Vector2I7F25 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I7F25 Dot(Vector2I7F25 other) {
            const long k = 1L << 23;
            return I7F25.FromBits((int)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I7F25 SaturatingDot(Vector2I7F25 other) {
            const long k = 1L << 23;
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I16F48 LengthSquared() {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I7F25 LengthHalf() => I7F25.FromBits(LengthInternal());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I8F24 Length() => I8F24.FromBits(LengthInternal());

    }

    partial struct I7F25 {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I7F25 SaturatingMul(Vector2I7F25 other) => other.SaturatingMul(this);
    }
}
