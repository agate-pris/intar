...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U27F5 Cross(Vector3U27F5 other) {
            const ulong k = 1UL << 5;
            var ax = (ulong)X.Bits;
            var ay = (ulong)Y.Bits;
            var az = (ulong)Z.Bits;
            ...
            return new Vector3U27F5(
                U27F5.FromBits((uint)(x / k)),
                U27F5.FromBits((uint)(y / k)),
                U27F5.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U56F8 WideningDot(Vector3U27F5 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U27F5 Dot(Vector3U27F5 other) => (U27F5)WideningDot(other);
