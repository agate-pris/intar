...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U9F23 Cross(Vector3U9F23 other) {
            ...
            return new Vector3U9F23(
                U9F23.FromBits((uint)(x / k)),
                U9F23.FromBits((uint)(y / k)),
                U9F23.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U20F44 WideningDot(Vector3U9F23 other) {
            ...
            var bits =
                ...
                (y.Bits / 4) +
                (z.Bits / 4);
            return U20F44.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U9F23 Dot(Vector3U9F23 other) => (U9F23)WideningDot(other);
