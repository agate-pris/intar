...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U23F9 Cross(Vector3U23F9 other) {
            const ulong k = 1UL << 9;
            var ax = (ulong)X.Bits;
            var ay = (ulong)Y.Bits;
            var az = (ulong)Z.Bits;
            ...
            return new Vector3U23F9(
                U23F9.FromBits((uint)(x / k)),
                U23F9.FromBits((uint)(y / k)),
                U23F9.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U48F16 WideningDot(Vector3U23F9 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U23F9 Dot(Vector3U23F9 other) => (U23F9)WideningDot(other);
