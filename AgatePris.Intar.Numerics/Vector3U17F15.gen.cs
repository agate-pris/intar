...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U17F15 Min(Vector3U17F15 other) => new Vector3U17F15(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U17F15 Max(Vector3U17F15 other) => new Vector3U17F15(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U17F15 WrappingAdd(Vector3U17F15 other) => new Vector3U17F15(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U17F15 WrappingSub(Vector3U17F15 other) => new Vector3U17F15(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U17F15 WrappingMul(Vector3U17F15 other) => new Vector3U17F15(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U17F15 WrappingAddSigned(Vector3I17F15 other) => new Vector3U17F15(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector3U17F15 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U17F15 SaturatingDot(Vector3U17F15 other) {
            const ulong k = 1UL << 13;
