...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I31F1(I31F1 value) : this(value, value, value) { }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I31F1(I31F1 x, Vector2I31F1 yz) : this(x, yz.X, yz.Y) { }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I31F1(Vector3I31F1 xyz) : this(xyz.X, xyz.Y, xyz.Z) { }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I31F1(Vector2I31F1 xy, I31F1 z) : this(xy.X, xy.Y, z) { }

        // Constants
        // ---------------------------------------

        public static Vector3I31F1 Zero {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new Vector3I31F1(I31F1.Zero);
        }
        public static Vector3I31F1 One {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new Vector3I31F1(I31F1.One);
        }
        public static Vector3I31F1 UnitX {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new Vector3I31F1(I31F1.One, I31F1.Zero, I31F1.Zero);
        }
        public static Vector3I31F1 UnitY {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new Vector3I31F1(I31F1.Zero, I31F1.One, I31F1.Zero);
        }
        public static Vector3I31F1 UnitZ {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new Vector3I31F1(I31F1.Zero, I31F1.Zero, I31F1.One);
        }
        ...
        public readonly Vector3I31F1 Half() => new Vector3I31F1(
            X.Half(),
            Y.Half(),
            Z.Half());

        public readonly Vector3I31F1 Twice() => new Vector3I31F1(
            X.Twice(),
            Y.Twice(),
            Z.Twice());

        public readonly Vector3I31F1 Clamp(I31F1 min, I31F1 max) => new Vector3I31F1(
            X.Clamp(min, max),
            Y.Clamp(min, max),
            Z.Clamp(min, max));

        public readonly Vector3I31F1 Clamp(
            Vector3I31F1 min, Vector3I31F1 max
        ) => new Vector3I31F1(
            X.Clamp(min.X, max.X),
            Y.Clamp(min.Y, max.Y),
            Z.Clamp(min.Z, max.Z));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I31F1 SaturatingAdd(Vector3I31F1 other) => new Vector3I31F1(
            X.SaturatingAdd(other.X),
            Y.SaturatingAdd(other.Y),
            Z.SaturatingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I31F1 SaturatingMul(I31F1 other) => new Vector3I31F1(
            X.SaturatingMul(other),
            Y.SaturatingMul(other),
            Z.SaturatingMul(other));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I31F1 Cross(Vector3I31F1 other) {
            const long k = 1L << 1;
            var ax = (long)X.Bits;
            var ay = (long)Y.Bits;
            var az = (long)Z.Bits;
            ...
            return new Vector3I31F1(
                I31F1.FromBits((int)(x / k)),
                I31F1.FromBits((int)(y / k)),
                I31F1.FromBits((int)(z / k)));
        }
    ...
    partial struct I31F1 {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I31F1 SaturatingMul(Vector3I31F1 other) => other.SaturatingMul(this);
    }
}
