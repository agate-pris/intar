...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U26F6 Cross(Vector3U26F6 other) {
            const ulong k = 1UL << 6;
            var ax = (ulong)X.Bits;
            var ay = (ulong)Y.Bits;
            var az = (ulong)Z.Bits;
            ...
            return new Vector3U26F6(
                U26F6.FromBits((uint)(x / k)),
                U26F6.FromBits((uint)(y / k)),
                U26F6.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U54F10 WideningDot(Vector3U26F6 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U26F6 Dot(Vector3U26F6 other) => (U26F6)WideningDot(other);
