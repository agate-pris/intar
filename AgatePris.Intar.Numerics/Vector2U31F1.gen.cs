...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U31F1 SaturatingMul(U31F1 other) => new Vector2U31F1(
            X.SaturatingMul(other),
            Y.SaturatingMul(other));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U31F1 Dot(Vector2U31F1 other) {
            return
                X * other.X +
                Y * other.Y;
        }
    ...
    partial struct U31F1 {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U31F1 SaturatingMul(Vector2U31F1 other) => other.SaturatingMul(this);
    }
}
