...
namespace AgatePris.Intar.Numerics {
    [Serializable]
    public partial struct I5F59 : IEquatable<I5F59>, IFormattable {
        // Consts
        // ------
...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public static I5F59 Zero {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => FromNum(0);
        }
        public static I5F59 One {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => FromNum(1);
        }
        public static I5F59 MinValue {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => FromBits(long.MinValue);
        }
        public static I5F59 MaxValue {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        public override bool Equals(object obj) => obj is I5F59 o && Equals(o);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(I5F59 other) => Bits == other.Bits;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 Min(I5F59 other) => FromBits(Math.Min(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 Max(I5F59 other) => FromBits(Math.Max(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 Abs() => FromBits(Math.Abs(Bits));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 Half() => FromBits(Mathi.Half(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 Twice() => FromBits(Mathi.Twice(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 WrappingAdd(I5F59 other) => FromBits(Overflowing.WrappingAdd(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 WrappingSub(I5F59 other) => FromBits(Overflowing.WrappingSub(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 WrappingMul(I5F59 other) => FromBits(Overflowing.WrappingMul(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 WrappingAddUnsigned(U5F59 other) => FromBits(Overflowing.WrappingAddUnsigned(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 WrappingSubUnsigned(U5F59 other) => FromBits(Overflowing.WrappingSubUnsigned(Bits, other.Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U5F59 UnsignedAbs() {
            return U5F59.FromBits(Overflowing.UnsignedAbs(Bits));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I5F59 LosslessMul(long other) => FromBits(Bits * other);
