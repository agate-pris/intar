...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U19F13 Min(Vector3U19F13 other) => new Vector3U19F13(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U19F13 Max(Vector3U19F13 other) => new Vector3U19F13(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U19F13 WrappingAdd(Vector3U19F13 other) => new Vector3U19F13(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U19F13 WrappingSub(Vector3U19F13 other) => new Vector3U19F13(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U19F13 WrappingMul(Vector3U19F13 other) => new Vector3U19F13(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U19F13 WrappingAddSigned(Vector3I19F13 other) => new Vector3U19F13(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U19F13 Dot(Vector3U19F13 other) {
            const ulong k = 1UL << 11;
            return U19F13.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U19F13 SaturatingDot(Vector3U19F13 other) {
            const ulong k = 1UL << 11;
