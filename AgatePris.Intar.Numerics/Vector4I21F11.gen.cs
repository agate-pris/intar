...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I44F20 WideningDot(Vector4I21F11 other) {
            ...
            var bits =
                ...
                (z.Bits / 4) +
                (w.Bits / 4);
            return I44F20.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I21F11 Dot(Vector4I21F11 other) => (I21F11)WideningDot(other);
