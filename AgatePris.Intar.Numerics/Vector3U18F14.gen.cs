...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U18F14 Cross(Vector3U18F14 other) {
            ...
            return new Vector3U18F14(
                U18F14.FromBits((uint)(x / k)),
                U18F14.FromBits((uint)(y / k)),
                U18F14.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U38F26 WideningDot(Vector3U18F14 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U18F14 Dot(Vector3U18F14 other) => (U18F14)WideningDot(other);
