...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U15F17 Min(Vector3U15F17 other) => new Vector3U15F17(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U15F17 Max(Vector3U15F17 other) => new Vector3U15F17(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U15F17 WrappingAdd(Vector3U15F17 other) => new Vector3U15F17(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U15F17 WrappingSub(Vector3U15F17 other) => new Vector3U15F17(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U15F17 WrappingMul(Vector3U15F17 other) => new Vector3U15F17(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U15F17 WrappingAddSigned(Vector3I15F17 other) => new Vector3U15F17(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector3U15F17 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U15F17 SaturatingDot(Vector3U15F17 other) {
            const ulong k = 1UL << 15;
