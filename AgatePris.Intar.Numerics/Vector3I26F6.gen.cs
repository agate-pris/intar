...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public static readonly Vector3I26F6 zero;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I26F6(I26F6 x, Vector2I26F6 yz) {
            X = x;
            Y = yz.X;
            Z = yz.Y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I26F6(Vector3I26F6 xyz) {
            X = xyz.X;
            Y = xyz.Y;
            Z = xyz.Z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I26F6(Vector2I26F6 xy, I26F6 z) {
            X = xy.X;
            Y = xy.Y;
            Z = z;
        }
...
#pragma warning restore IDE1006 // 命名スタイル
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"Vector3I26F6({X}, {Y}, {Z})";
