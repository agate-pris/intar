...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U25F7 Min(Vector4U25F7 other) => new Vector4U25F7(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z),
            W.Min(other.W));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U25F7 Max(Vector4U25F7 other) => new Vector4U25F7(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z),
            W.Max(other.W));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U25F7 WrappingAdd(Vector4U25F7 other) => new Vector4U25F7(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U25F7 WrappingSub(Vector4U25F7 other) => new Vector4U25F7(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U25F7 WrappingMul(Vector4U25F7 other) => new Vector4U25F7(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U25F7 WrappingAddSigned(Vector4I25F7 other) => new Vector4U25F7(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector4U25F7 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U25F7 Dot(Vector4U25F7 other) {
            const ulong k = 1UL << 5;
            return U25F7.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U25F7 SaturatingDot(Vector4U25F7 other) {
            const ulong k = 1UL << 5;
