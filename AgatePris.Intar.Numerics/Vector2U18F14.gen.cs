...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U18F14 Min(Vector2U18F14 other) => new Vector2U18F14(
            X.Min(other.X),
            Y.Min(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U18F14 Max(Vector2U18F14 other) => new Vector2U18F14(
            X.Max(other.X),
            Y.Max(other.Y));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U18F14 WrappingAdd(Vector2U18F14 other) => new Vector2U18F14(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U18F14 WrappingSub(Vector2U18F14 other) => new Vector2U18F14(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U18F14 WrappingMul(Vector2U18F14 other) => new Vector2U18F14(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U18F14 WrappingAddSigned(Vector2I18F14 other) => new Vector2U18F14(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector2U18F14 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U18F14 Dot(Vector2U18F14 other) {
            const ulong k = 1UL << 12;
            return U18F14.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U18F14 SaturatingDot(Vector2U18F14 other) {
            const ulong k = 1UL << 12;
