...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 Min(Vector2I6F26 other) => new Vector2I6F26(
            X.Min(other.X),
            Y.Min(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 Max(Vector2I6F26 other) => new Vector2I6F26(
            X.Max(other.X),
            Y.Max(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 Abs() => new Vector2I6F26(
            X.Abs(),
            Y.Abs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 WrappingAdd(Vector2I6F26 other) => new Vector2I6F26(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 WrappingSub(Vector2I6F26 other) => new Vector2I6F26(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 WrappingMul(Vector2I6F26 other) => new Vector2I6F26(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 WrappingAddUnsigned(Vector2U6F26 other) => new Vector2I6F26(
            X.WrappingAddUnsigned(other.X),
            Y.WrappingAddUnsigned(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2I6F26 WrappingSubUnsigned(Vector2U6F26 other) => new Vector2I6F26(
            X.WrappingSubUnsigned(other.X),
            Y.WrappingSubUnsigned(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U6F26 UnsignedAbs() => new Vector2U6F26(
            X.UnsignedAbs(),
            Y.UnsignedAbs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly long DotInternal(Vector2I6F26 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I6F26 Dot(Vector2I6F26 other) {
            const long k = 1L << 24;
            return I6F26.FromBits((int)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I6F26 SaturatingDot(Vector2I6F26 other) {
            const long k = 1L << 24;
