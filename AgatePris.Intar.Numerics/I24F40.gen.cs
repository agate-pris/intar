...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public override bool Equals(object obj) => obj is I24F40 o && Equals(o);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(I24F40 other) => Bits == other.Bits;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Min(I24F40 other) => FromBits(Math.Min(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Max(I24F40 other) => FromBits(Math.Max(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Abs() => FromBits(Math.Abs(Bits));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Half() => FromBits(Mathi.Half(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Twice() => FromBits(Mathi.Twice(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 WrappingAdd(I24F40 other) => FromBits(Overflowing.WrappingAdd(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 WrappingSub(I24F40 other) => FromBits(Overflowing.WrappingSub(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 WrappingMul(I24F40 other) => FromBits(Overflowing.WrappingMul(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 WrappingAddUnsigned(U24F40 other) => FromBits(Overflowing.WrappingAddUnsigned(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 WrappingSubUnsigned(U24F40 other) => FromBits(Overflowing.WrappingSubUnsigned(Bits, other.Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U24F40 UnsignedAbs() {
            return U24F40.FromBits(Overflowing.UnsignedAbs(Bits));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 LosslessMul(long other) => FromBits(Bits * other);
