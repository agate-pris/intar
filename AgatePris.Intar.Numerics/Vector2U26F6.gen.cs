...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public override bool Equals(object obj) => obj is Vector2U26F6 o && Equals(o);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Vector2U26F6 other)
            => other.X == X
            && other.Y == Y;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 Min(Vector2U26F6 other) => new Vector2U26F6(
            X.Min(other.X),
            Y.Min(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 Max(Vector2U26F6 other) => new Vector2U26F6(
            X.Max(other.X),
            Y.Max(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 Half() => new Vector2U26F6(
            X.Half(),
            Y.Half());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 Twice() => new Vector2U26F6(
            X.Twice(),
            Y.Twice());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 Clamp(U26F6 min, U26F6 max) => new Vector2U26F6(
            X.Clamp(min, max),
            Y.Clamp(min, max));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 Clamp(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 WrappingAdd(Vector2U26F6 other) => new Vector2U26F6(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 WrappingSub(Vector2U26F6 other) => new Vector2U26F6(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 WrappingMul(Vector2U26F6 other) => new Vector2U26F6(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 WrappingAddSigned(Vector2I26F6 other) => new Vector2U26F6(
            X.WrappingAddSigned(other.X),
            Y.WrappingAddSigned(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 SaturatingAdd(Vector2U26F6 other) => new Vector2U26F6(
            X.SaturatingAdd(other.X),
            Y.SaturatingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 SaturatingMul(U26F6 other) => new Vector2U26F6(
            X.SaturatingMul(other),
            Y.SaturatingMul(other));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ulong DotInternal(Vector2U26F6 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U26F6 Dot(Vector2U26F6 other) {
            const ulong k = 1UL << 4;
            return U26F6.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U26F6 SaturatingDot(Vector2U26F6 other) {
            const ulong k = 1UL << 4;
    ...
    partial struct U26F6 {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector2U26F6 SaturatingMul(Vector2U26F6 other) => other.SaturatingMul(this);
    }
}
