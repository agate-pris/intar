...
namespace AgatePris.Intar.Mathematics {
    ...
    public struct Vector4I10F22 : IEquatable<Vector4I10F22>, IFormattable {
        ...
        public static readonly Vector4I10F22 zero;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4I10F22(I10F22 x, I10F22 y, Vector2I10F22 zw) {
            this.x = x;
            this.y = y;
            z = zw.x;
            w = zw.y;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4I10F22(I10F22 x, Vector3I10F22 yzw) {
            this.x = x;
            y = yzw.x;
            z = yzw.y;
            w = yzw.z;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4I10F22(Vector2I10F22 xy, Vector2I10F22 zw) {
            x = xy.x;
            y = xy.y;
            z = zw.x;
            w = zw.y;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4I10F22(Vector4I10F22 xyzw) {
            x = xyzw.x;
            y = xyzw.y;
            z = xyzw.z;
            w = xyzw.w;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4I10F22(I10F22 x, Vector2I10F22 yz, I10F22 w) {
            this.x = x;
            y = yz.x;
            z = yz.y;
            this.w = w;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4I10F22(Vector3I10F22 xyz, I10F22 w) {
            x = xyz.x;
            y = xyz.y;
            z = xyz.z;
            this.w = w;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4I10F22(Vector2I10F22 xy, I10F22 z, I10F22 w) {
            x = xy.x;
            y = xy.y;
            this.z = z;
            this.w = w;
