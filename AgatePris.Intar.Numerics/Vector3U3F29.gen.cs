...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public static readonly Vector3U3F29 zero;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U3F29(U3F29 x, Vector2U3F29 yz) {
            X = x;
            Y = yz.X;
            Z = yz.Y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U3F29(Vector3U3F29 xyz) {
            X = xyz.X;
            Y = xyz.Y;
            Z = xyz.Z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U3F29(Vector2U3F29 xy, U3F29 z) {
            X = xy.X;
            Y = xy.Y;
            Z = z;
        }
...
#pragma warning restore IDE1006 // 命名スタイル
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"Vector3U3F29({X}, {Y}, {Z})";
