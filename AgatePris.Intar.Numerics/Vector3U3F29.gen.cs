...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U3F29 Cross(Vector3U3F29 other) {
            ...
            return new Vector3U3F29(
                U3F29.FromBits((uint)(x / k)),
                U3F29.FromBits((uint)(y / k)),
                U3F29.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U8F56 WideningDot(Vector3U3F29 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U3F29 Dot(Vector3U3F29 other) => (U3F29)WideningDot(other);
