...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I24F40 WideningDot(Vector4I11F21 other) {
            ...
            var bits =
                ...
                (z.Bits / 4) +
                (w.Bits / 4);
            return I24F40.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I11F21 Dot(Vector4I11F21 other) => (I11F21)WideningDot(other);
