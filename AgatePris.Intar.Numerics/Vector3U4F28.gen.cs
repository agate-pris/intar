...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U4F28 Min(Vector3U4F28 other) => new Vector3U4F28(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U4F28 Max(Vector3U4F28 other) => new Vector3U4F28(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U4F28 WrappingAdd(Vector3U4F28 other) => new Vector3U4F28(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U4F28 WrappingSub(Vector3U4F28 other) => new Vector3U4F28(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U4F28 WrappingMul(Vector3U4F28 other) => new Vector3U4F28(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U4F28 WrappingAddSigned(Vector3I4F28 other) => new Vector3U4F28(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector3U4F28 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U4F28 SaturatingDot(Vector3U4F28 other) {
            const ulong k = 1UL << 26;
