...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 Min(Vector3U7F25 other) => new Vector3U7F25(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 Max(Vector3U7F25 other) => new Vector3U7F25(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 Half() => new Vector3U7F25(
            X.Half(),
            Y.Half(),
            Z.Half());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 Twice() => new Vector3U7F25(
            X.Twice(),
            Y.Twice(),
            Z.Twice());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 Clamp(U7F25 min, U7F25 max) => new Vector3U7F25(
            X.Clamp(min, max),
            Y.Clamp(min, max),
            Z.Clamp(min, max));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 Clamp(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 WrappingAdd(Vector3U7F25 other) => new Vector3U7F25(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 WrappingSub(Vector3U7F25 other) => new Vector3U7F25(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 WrappingMul(Vector3U7F25 other) => new Vector3U7F25(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 WrappingAddSigned(Vector3I7F25 other) => new Vector3U7F25(
            X.WrappingAddSigned(other.X),
            Y.WrappingAddSigned(other.Y),
            Z.WrappingAddSigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 SaturatingAdd(Vector3U7F25 other) => new Vector3U7F25(
            X.SaturatingAdd(other.X),
            Y.SaturatingAdd(other.Y),
            Z.SaturatingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 SaturatingMul(U7F25 other) => new Vector3U7F25(
            X.SaturatingMul(other),
            Y.SaturatingMul(other),
            Z.SaturatingMul(other));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector3U7F25 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U7F25 Dot(Vector3U7F25 other) {
            const ulong k = 1UL << 23;
            return U7F25.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U7F25 SaturatingDot(Vector3U7F25 other) {
            const ulong k = 1UL << 23;
    ...
    partial struct U7F25 {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 SaturatingMul(Vector3U7F25 other) => other.SaturatingMul(this);
    }
}
