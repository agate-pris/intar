...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 Cross(Vector3U7F25 other) {
            ...
            return new Vector3U7F25(
                U7F25.FromBits((uint)(x / k)),
                U7F25.FromBits((uint)(y / k)),
                U7F25.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U16F48 WideningDot(Vector3U7F25 other) {
            ...
            var bits =
                ...
                (y.Bits / 4) +
                (z.Bits / 4);
            return U16F48.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U7F25 Dot(Vector3U7F25 other) => (U7F25)WideningDot(other);
