...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U30F2 Cross(Vector3U30F2 other) {
            const ulong k = 1UL << 2;
            var ax = (ulong)X.Bits;
            var ay = (ulong)Y.Bits;
            var az = (ulong)Z.Bits;
            ...
            return new Vector3U30F2(
                U30F2.FromBits((uint)(x / k)),
                U30F2.FromBits((uint)(y / k)),
                U30F2.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U62F2 WideningDot(Vector3U30F2 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U30F2 Dot(Vector3U30F2 other) => (U30F2)WideningDot(other);
