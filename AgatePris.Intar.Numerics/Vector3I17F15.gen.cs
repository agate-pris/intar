...
namespace AgatePris.Intar.Mathematics {
    ...
    public struct Vector3I17F15 : IEquatable<Vector3I17F15>, IFormattable {
        ...
        public static readonly Vector3I17F15 zero;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I17F15(I17F15 x, Vector2I17F15 yz) {
            this.x = x;
            y = yz.x;
            z = yz.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I17F15(Vector3I17F15 xyz) {
            x = xyz.x;
            y = xyz.y;
            z = xyz.z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3I17F15(Vector2I17F15 xy, I17F15 z) {
            x = xy.x;
            y = xy.y;
            this.z = z;
        }
...
#pragma warning restore IDE1006 // 命名スタイル
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"Vector3I17F15({x}, {y}, {z})";
