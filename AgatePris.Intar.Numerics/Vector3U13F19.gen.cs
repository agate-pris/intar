...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U13F19 Cross(Vector3U13F19 other) {
            ...
            return new Vector3U13F19(
                U13F19.FromBits((uint)(x / k)),
                U13F19.FromBits((uint)(y / k)),
                U13F19.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U28F36 WideningDot(Vector3U13F19 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U13F19 Dot(Vector3U13F19 other) => (U13F19)WideningDot(other);
