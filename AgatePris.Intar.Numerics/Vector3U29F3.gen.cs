...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U29F3 Cross(Vector3U29F3 other) {
            const ulong k = 1UL << 3;
            var ax = (ulong)X.Bits;
            var ay = (ulong)Y.Bits;
            var az = (ulong)Z.Bits;
            ...
            return new Vector3U29F3(
                U29F3.FromBits((uint)(x / k)),
                U29F3.FromBits((uint)(y / k)),
                U29F3.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U60F4 WideningDot(Vector3U29F3 other) {
            ...
            var bits =
                ...
                (y.Bits / 4) +
                (z.Bits / 4);
            return U60F4.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U29F3 Dot(Vector3U29F3 other) => (U29F3)WideningDot(other);
