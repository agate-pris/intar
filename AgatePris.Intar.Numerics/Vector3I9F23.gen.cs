...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 Min(Vector3I9F23 other) => new Vector3I9F23(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 Max(Vector3I9F23 other) => new Vector3I9F23(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 Abs() => new Vector3I9F23(
            X.Abs(),
            Y.Abs(),
            Z.Abs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 WrappingAdd(Vector3I9F23 other) => new Vector3I9F23(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 WrappingSub(Vector3I9F23 other) => new Vector3I9F23(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 WrappingMul(Vector3I9F23 other) => new Vector3I9F23(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 WrappingAddUnsigned(Vector3U9F23 other) => new Vector3I9F23(
            X.WrappingAddUnsigned(other.X),
            Y.WrappingAddUnsigned(other.Y),
            Z.WrappingAddUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I9F23 WrappingSubUnsigned(Vector3U9F23 other) => new Vector3I9F23(
            X.WrappingSubUnsigned(other.X),
            Y.WrappingSubUnsigned(other.Y),
            Z.WrappingSubUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U9F23 UnsignedAbs() => new Vector3U9F23(
            X.UnsignedAbs(),
            Y.UnsignedAbs(),
            Z.UnsignedAbs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly void CrossInternal(Vector3I9F23 other, out long x, out long y, out long z) {
            var ax = (long)X.Bits;
            var ay = (long)Y.Bits;
            var az = (long)Z.Bits;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly long DotInternal(Vector3I9F23 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I9F23 SaturatingDot(Vector3I9F23 other) {
            const long k = 1L << 21;
