...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 Min(Vector3I6F26 other) => new Vector3I6F26(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 Max(Vector3I6F26 other) => new Vector3I6F26(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 Abs() => new Vector3I6F26(
            X.Abs(),
            Y.Abs(),
            Z.Abs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 WrappingAdd(Vector3I6F26 other) => new Vector3I6F26(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 WrappingSub(Vector3I6F26 other) => new Vector3I6F26(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 WrappingMul(Vector3I6F26 other) => new Vector3I6F26(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 WrappingAddUnsigned(Vector3U6F26 other) => new Vector3I6F26(
            X.WrappingAddUnsigned(other.X),
            Y.WrappingAddUnsigned(other.Y),
            Z.WrappingAddUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 WrappingSubUnsigned(Vector3U6F26 other) => new Vector3I6F26(
            X.WrappingSubUnsigned(other.X),
            Y.WrappingSubUnsigned(other.Y),
            Z.WrappingSubUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U6F26 UnsignedAbs() => new Vector3U6F26(
            X.UnsignedAbs(),
            Y.UnsignedAbs(),
            Z.UnsignedAbs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I6F26 SaturatingCross(Vector3I6F26 other) {
            const long k = 1L << 26;
            CrossInternal(other, out var x, out var y, out var z);
            x /= k;
            if (x > int.MaxValue) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly long DotInternal(Vector3I6F26 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I6F26 SaturatingDot(Vector3I6F26 other) {
            const long k = 1L << 24;
