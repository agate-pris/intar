...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public static readonly Vector3U31F1 zero;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U31F1(U31F1 x, Vector2U31F1 yz) {
            X = x;
            Y = yz.X;
            Z = yz.Y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U31F1(Vector3U31F1 xyz) {
            X = xyz.X;
            Y = xyz.Y;
            Z = xyz.Z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3U31F1(Vector2U31F1 xy, U31F1 z) {
            X = xy.X;
            Y = xy.Y;
            Z = z;
        }
...
#pragma warning restore IDE1006 // 命名スタイル
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"Vector3U31F1({X}, {Y}, {Z})";
