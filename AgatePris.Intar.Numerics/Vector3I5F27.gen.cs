...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 Min(Vector3I5F27 other) => new Vector3I5F27(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 Max(Vector3I5F27 other) => new Vector3I5F27(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 Abs() => new Vector3I5F27(
            X.Abs(),
            Y.Abs(),
            Z.Abs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 WrappingAdd(Vector3I5F27 other) => new Vector3I5F27(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 WrappingSub(Vector3I5F27 other) => new Vector3I5F27(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 WrappingMul(Vector3I5F27 other) => new Vector3I5F27(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 WrappingAddUnsigned(Vector3U5F27 other) => new Vector3I5F27(
            X.WrappingAddUnsigned(other.X),
            Y.WrappingAddUnsigned(other.Y),
            Z.WrappingAddUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I5F27 WrappingSubUnsigned(Vector3U5F27 other) => new Vector3I5F27(
            X.WrappingSubUnsigned(other.X),
            Y.WrappingSubUnsigned(other.Y),
            Z.WrappingSubUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U5F27 UnsignedAbs() => new Vector3U5F27(
            X.UnsignedAbs(),
            Y.UnsignedAbs(),
            Z.UnsignedAbs());
