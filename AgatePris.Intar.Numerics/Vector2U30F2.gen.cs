...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U30F2 Min(Vector2U30F2 other) => new Vector2U30F2(
            X.Min(other.X),
            Y.Min(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U30F2 Max(Vector2U30F2 other) => new Vector2U30F2(
            X.Max(other.X),
            Y.Max(other.Y));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U30F2 WrappingAdd(Vector2U30F2 other) => new Vector2U30F2(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U30F2 WrappingSub(Vector2U30F2 other) => new Vector2U30F2(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U30F2 WrappingMul(Vector2U30F2 other) => new Vector2U30F2(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U30F2 WrappingAddSigned(Vector2I30F2 other) => new Vector2U30F2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U30F2 SaturatingDot(Vector2U30F2 other) {
            const ulong k = 1UL << 0;
