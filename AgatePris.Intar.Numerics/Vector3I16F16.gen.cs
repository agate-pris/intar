...
namespace AgatePris.Intar.Mathematics {
    [Serializable]
    public struct I16F16_3 : IEquatable<I16F16_3>, IFormattable {
        // Fields
        // ---------------------------------------
        ...
        public static readonly I16F16_3 zero;

        // Constructors
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I16F16_3(I16F16 x, I16F16 y, I16F16 z) {
            this.x = x;
            this.y = y;
            this.z = z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I16F16_3(I16F16 x, I16F16_2 yz) {
            this.x = x;
            y = yz.x;
            z = yz.y;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I16F16_3(I16F16_2 xy, I16F16 z) {
            x = xy.x;
            y = xy.y;
            this.z = z;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I16F16_3 operator +(I16F16_3 a, I16F16_3 b) => new I16F16_3(
            a.x + b.x,
            a.y + b.y,
            a.z + b.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I16F16_3 operator *(I16F16_3 a, I16F16 b) => new I16F16_3(
            a.x * b,
            a.y * b,
            a.z * b);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I16F16_3 operator *(I16F16 a, I16F16_3 b) => new I16F16_3(
            a * b.x,
            a * b.y,
            a * b.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(I16F16_3 lhs, I16F16_3 rhs) => lhs.Equals(rhs);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator !=(I16F16_3 lhs, I16F16_3 rhs) => !(lhs == rhs);

        // Object
        // ---------------------------------------

        public override readonly bool Equals(object obj) => obj is I16F16_3 o && Equals(o);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly int GetHashCode() => HashCode.Combine(x, y, z);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly string ToString() => $"I16F16_3({x}, {y}, {z})";

        // IEquatable<I16F16_3>
        // ---------------------------------------

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(I16F16_3 other)
            => other.x == x
            && other.y == y
            && other.z == z;
        ...
        public readonly string ToString(string format, IFormatProvider formatProvider) {
            ...
            return $"I16F16_3({x}, {y}, {z})";
        }
    }

    public static partial class math {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I16F16_3 I16F16_3(I16F16 x, I16F16 y, I16F16 z) => new I16F16_3(x, y, z);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I16F16_3 I16F16_3(I16F16 x, I16F16_2 yz) => new I16F16_3(x, yz);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I16F16_3 I16F16_3(I16F16_3 xyz) => new I16F16_3(xyz);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I16F16_3 I16F16_3(I16F16_2 xy, I16F16 z) => new I16F16_3(xy, z);
    }
}
