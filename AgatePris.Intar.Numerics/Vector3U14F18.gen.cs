...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U14F18 Cross(Vector3U14F18 other) {
            ...
            return new Vector3U14F18(
                U14F18.FromBits((uint)(x / k)),
                U14F18.FromBits((uint)(y / k)),
                U14F18.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U30F34 WideningDot(Vector3U14F18 other) {
            ...
            var bits =
                ...
                (y.Bits / 4) +
                (z.Bits / 4);
            return U30F34.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U14F18 Dot(Vector3U14F18 other) => (U14F18)WideningDot(other);
