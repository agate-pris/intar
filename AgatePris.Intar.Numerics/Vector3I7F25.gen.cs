...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 Min(Vector3I7F25 other) => new Vector3I7F25(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 Max(Vector3I7F25 other) => new Vector3I7F25(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 Abs() => new Vector3I7F25(
            X.Abs(),
            Y.Abs(),
            Z.Abs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 WrappingAdd(Vector3I7F25 other) => new Vector3I7F25(
            X.WrappingAdd(other.X),
            Y.WrappingAdd(other.Y),
            Z.WrappingAdd(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 WrappingSub(Vector3I7F25 other) => new Vector3I7F25(
            X.WrappingSub(other.X),
            Y.WrappingSub(other.Y),
            Z.WrappingSub(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 WrappingMul(Vector3I7F25 other) => new Vector3I7F25(
            X.WrappingMul(other.X),
            Y.WrappingMul(other.Y),
            Z.WrappingMul(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 WrappingAddUnsigned(Vector3U7F25 other) => new Vector3I7F25(
            X.WrappingAddUnsigned(other.X),
            Y.WrappingAddUnsigned(other.Y),
            Z.WrappingAddUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 WrappingSubUnsigned(Vector3U7F25 other) => new Vector3I7F25(
            X.WrappingSubUnsigned(other.X),
            Y.WrappingSubUnsigned(other.Y),
            Z.WrappingSubUnsigned(other.Z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U7F25 UnsignedAbs() => new Vector3U7F25(
            X.UnsignedAbs(),
            Y.UnsignedAbs(),
            Z.UnsignedAbs());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly void CrossInternal(Vector3I7F25 other, out long x, out long y, out long z) {
            var ax = (long)X.Bits;
            var ay = (long)Y.Bits;
            var az = (long)Z.Bits;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3I7F25 SaturatingCross(Vector3I7F25 other) {
            const long k = 1L << 25;
            CrossInternal(other, out var x, out var y, out var z);
            x /= k;
            if (x > int.MaxValue) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly long DotInternal(Vector3I7F25 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I7F25 Dot(Vector3I7F25 other) {
            const long k = 1L << 23;
            return I7F25.FromBits((int)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly I7F25 SaturatingDot(Vector3I7F25 other) {
            const long k = 1L << 23;
