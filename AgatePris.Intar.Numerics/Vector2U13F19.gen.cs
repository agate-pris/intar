...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U13F19 Min(Vector2U13F19 other) => new Vector2U13F19(
            X.Min(other.X),
            Y.Min(other.Y));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector2U13F19 Max(Vector2U13F19 other) => new Vector2U13F19(
            X.Max(other.X),
            Y.Max(other.Y));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U13F19 Dot(Vector2U13F19 other) {
            const ulong k = 1UL << 17;
            return U13F19.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U13F19 SaturatingDot(Vector2U13F19 other) {
            const ulong k = 1UL << 17;
