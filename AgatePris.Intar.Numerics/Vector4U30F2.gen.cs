...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U30F2 Min(Vector4U30F2 other) => new Vector4U30F2(
            X.Min(other.X),
            Y.Min(other.Y),
            Z.Min(other.Z),
            W.Min(other.W));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U30F2 Max(Vector4U30F2 other) => new Vector4U30F2(
            X.Max(other.X),
            Y.Max(other.Y),
            Z.Max(other.Z),
            W.Max(other.W));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U30F2 WrappingAdd(Vector4U30F2 other) => new Vector4U30F2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U30F2 WrappingSub(Vector4U30F2 other) => new Vector4U30F2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U30F2 WrappingMul(Vector4U30F2 other) => new Vector4U30F2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector4U30F2 WrappingAddSigned(Vector4I30F2 other) => new Vector4U30F2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly ulong DotInternal(Vector4U30F2 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U30F2 Dot(Vector4U30F2 other) {
            const ulong k = 1UL << 0;
            return U30F2.FromBits((uint)(DotInternal(other) / k));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U30F2 SaturatingDot(Vector4U30F2 other) {
            const ulong k = 1UL << 0;
