...
namespace AgatePris.Intar.Numerics {
    [Serializable]
    public partial struct I52F12 : IEquatable<I52F12>, IFormattable {
        // Consts
        // ------
...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public override bool Equals(object obj) => obj is I52F12 o && Equals(o);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(I52F12 other) => Bits == other.Bits;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 Min(I52F12 other) => FromBits(Math.Min(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 Max(I52F12 other) => FromBits(Math.Max(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 Abs() => FromBits(Math.Abs(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I52F12 Clamp(
            I52F12 min, I52F12 max
        ) => FromBits(Mathi.Clamp(Bits, min.Bits, max.Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 Half() => FromBits(Mathi.Half(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 Twice() => FromBits(Mathi.Twice(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 WrappingAdd(I52F12 other) => FromBits(Overflowing.WrappingAdd(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 WrappingSub(I52F12 other) => FromBits(Overflowing.WrappingSub(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 WrappingMul(I52F12 other) => FromBits(Overflowing.WrappingMul(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 WrappingAddUnsigned(U52F12 other) => FromBits(Overflowing.WrappingAddUnsigned(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I52F12 WrappingSubUnsigned(U52F12 other) => FromBits(Overflowing.WrappingSubUnsigned(Bits, other.Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U52F12 UnsignedAbs() {
            return U52F12.FromBits(Overflowing.UnsignedAbs(Bits));
        }
