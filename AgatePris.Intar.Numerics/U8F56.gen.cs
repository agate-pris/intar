...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        public override bool Equals(object obj) => obj is U8F56 o && Equals(o);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(U8F56 other) => Bits == other.Bits;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 Min(U8F56 other) => FromBits(Math.Min(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 Max(U8F56 other) => FromBits(Math.Max(Bits, other.Bits));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 Half() => FromBits(Mathi.Half(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 Twice() => FromBits(Mathi.Twice(Bits));

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 WrappingAdd(U8F56 other) => FromBits(Overflowing.WrappingAdd(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 WrappingSub(U8F56 other) => FromBits(Overflowing.WrappingSub(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 WrappingMul(U8F56 other) => FromBits(Overflowing.WrappingMul(Bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U8F56 WrappingAddSigned(I8F56 other) => FromBits(Overflowing.WrappingAddSigned(Bits, other.Bits));
