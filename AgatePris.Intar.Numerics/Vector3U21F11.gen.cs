...
#pragma warning restore CA1051 // 参照可能なインスタンス フィールドを宣言しません
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly Vector3U21F11 Cross(Vector3U21F11 other) {
            ...
            return new Vector3U21F11(
                U21F11.FromBits((uint)(x / k)),
                U21F11.FromBits((uint)(y / k)),
                U21F11.FromBits((uint)(z / k)));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U44F20 WideningDot(Vector3U21F11 other) {
            ...
            var bits =
                ...
                (y.Bits / 4) +
                (z.Bits / 4);
            return U44F20.FromBits(bits);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly U21F11 Dot(Vector3U21F11 other) => (U21F11)WideningDot(other);
