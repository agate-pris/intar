...
#pragma warning restore IDE0079 // 不要な抑制を削除します
        ...
        public static explicit operator System.Numerics.Vector4(Vector4Int32 a) {
            return new System.Numerics.Vector4(a.X, a.Y, a.Z, a.W);
        }

#if UNITY_5_3_OR_NEWER
        public static explicit operator UnityEngine.Vector4(Vector4Int32 a) {
            return new UnityEngine.Vector4(a.X, a.Y, a.Z, a.W);
        }
#endif

#if UNITY_2018_1_OR_NEWER
        public static explicit operator Unity.Mathematics.float4(Vector4Int32 a) {
...
#pragma warning restore IDE0079 // 不要な抑制を削除します
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal (Vector4Bool isNegative, Vector4UInt32 unsignedAbs) IsNegativeAndUnsignedAbs() {
            var isNegative = IsNegative();
            var unsignedAbs = new Vector4UInt32(
                unchecked((uint)(isNegative.X ? Overflowing.WrappingNeg(X) : X)),
                unchecked((uint)(isNegative.Y ? Overflowing.WrappingNeg(Y) : Y)),
                unchecked((uint)(isNegative.Z ? Overflowing.WrappingNeg(Z) : Z)),
                unchecked((uint)(isNegative.W ? Overflowing.WrappingNeg(W) : W))
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public Vector3Int32 XYZ0() => new Vector3Int32(X, Y, Z, 0);
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public Vector3Int32 XYZ1() => new Vector3Int32(X, Y, Z, 1);
