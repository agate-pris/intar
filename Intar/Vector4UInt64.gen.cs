...
#pragma warning restore IDE0079 // 不要な抑制を削除します
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector4Bool operator <(ulong left, Vector4UInt64 right) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector4UInt64 operator <<(Vector4UInt64 left, int right) {
...
#pragma warning restore IDE0079 // 不要な抑制を削除します
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector4UInt64 AbsDiff(Vector4UInt64 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt128 Dot(Vector4UInt64 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt128 DistanceSquared(Vector4UInt64 other) {
            return AbsDiff(other).LengthSquared();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ulong Distance(Vector4UInt64 other) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public Vector4UInt64 XYZ0() => new Vector4UInt64(X, Y, Z, 0);
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public Vector4UInt64 XYZ1() => new Vector4UInt64(X, Y, Z, 1);
