...
#pragma warning restore IDE0079 // 不要な抑制を削除します
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public Vector3UInt64 XYZ0() => new Vector3UInt64(X, Y, Z, 0);
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public Vector3UInt64 XYZ1() => new Vector3UInt64(X, Y, Z, 1);
