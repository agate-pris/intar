...
namespace AgatePris.Intar.Fixed {
    ...
    struct I25F7 : IEquatable<I25F7>, IFormattable {
        // Consts
        // ------
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I25F7 Min(I25F7 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I25F7 Max(I25F7 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I25F7 Clamp(I25F7 min, I25F7 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
