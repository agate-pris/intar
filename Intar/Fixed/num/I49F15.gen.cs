...
namespace AgatePris.Intar.Fixed {
    ...
    struct I49F15 : IEquatable<I49F15>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I49F15 Min(I49F15 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I49F15 Max(I49F15 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I49F15 Clamp(I49F15 min, I49F15 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
