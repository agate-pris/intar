...
namespace AgatePris.Intar.Fixed {
    ...
    struct I24F40 : IEquatable<I24F40>, IFormattable {
        // Consts
        // ------
        ...
        public static readonly I24F40 MinValue = FromBits(long.MinValue);
        public static readonly I24F40 MaxValue = FromBits(long.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Min(I24F40 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Max(I24F40 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Clamp(I24F40 min, I24F40 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I24F40 Abs() => FromBits(System.Math.Abs(bits));
