...
namespace AgatePris.Intar.Fixed {
    ...
    struct I21F11 : IEquatable<I21F11>, IFormattable {
        ...
        public static readonly I21F11 MinValue = FromBits(int.MinValue);
        public static readonly I21F11 MaxValue = FromBits(int.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I21F11 Min(I21F11 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I21F11 Max(I21F11 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I21F11 Clamp(I21F11 min, I21F11 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I21F11 Abs() => FromBits(System.Math.Abs(bits));
