...
namespace AgatePris.Intar.Fixed {
    ...
    struct U3F61 : IEquatable<U3F61>, IFormattable {
        // Consts
        // ------
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U3F61 Min(U3F61 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U3F61 Max(U3F61 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U3F61 Clamp(U3F61 min, U3F61 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
