...
namespace AgatePris.Intar.Fixed {
    ...
    struct U35F29 : IEquatable<U35F29>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U35F29 Min(U35F29 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U35F29 Max(U35F29 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U35F29 Clamp(U35F29 min, U35F29 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
