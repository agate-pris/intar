...
namespace AgatePris.Intar.Fixed {
    ...
    struct U32F32 : IEquatable<U32F32>, IFormattable {
        // Consts
        // ------
        ...
        public static readonly U32F32 Zero = FromNum(0);
        public static readonly U32F32 One = FromNum(1);
        public static readonly U32F32 MinValue = FromBits(ulong.MinValue);
        public static readonly U32F32 MaxValue = FromBits(ulong.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U32F32 Min(U32F32 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U32F32 Max(U32F32 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U32F32 Clamp(U32F32 min, U32F32 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
