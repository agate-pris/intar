...
namespace AgatePris.Intar.Fixed {
    ...
    struct I6F26 : IEquatable<I6F26>, IFormattable {
        // Consts
        // ------
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I6F26 Min(I6F26 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I6F26 Max(I6F26 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I6F26 Clamp(I6F26 min, I6F26 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
