...
namespace AgatePris.Intar.Fixed {
    ...
    struct U34F30 : IEquatable<U34F30>, IFormattable {
        // Consts
        // ------
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U34F30 Min(U34F30 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U34F30 Max(U34F30 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U34F30 Clamp(U34F30 min, U34F30 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
