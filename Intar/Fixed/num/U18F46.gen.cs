...
namespace AgatePris.Intar.Fixed {
    ...
    struct U18F46 : IEquatable<U18F46>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U18F46 Min(U18F46 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U18F46 Max(U18F46 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U18F46 Clamp(U18F46 min, U18F46 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
