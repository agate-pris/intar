...
namespace AgatePris.Intar.Fixed {
    ...
    struct U21F43 : IEquatable<U21F43>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U21F43 Min(U21F43 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U21F43 Max(U21F43 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U21F43 Clamp(U21F43 min, U21F43 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
