...
namespace AgatePris.Intar.Fixed {
    ...
    public struct I30F2 : IEquatable<I30F2>, IFormattable {
        ...
        public static readonly I30F2 MinValue = FromNum(int.MinValue);
        public static readonly I30F2 MaxValue = FromNum(int.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public I30F2 LosslessMul(int other) => I30F2.FromBits(bits * other);
