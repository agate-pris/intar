...
namespace AgatePris.Intar.Fixed {
    ...
    struct I30F2 : IEquatable<I30F2>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I30F2 Min(I30F2 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I30F2 Max(I30F2 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I30F2 Clamp(I30F2 min, I30F2 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
