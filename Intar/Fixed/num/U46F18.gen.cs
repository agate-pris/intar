...
namespace AgatePris.Intar.Fixed {
    ...
    struct U46F18 : IEquatable<U46F18>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U46F18 Min(U46F18 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U46F18 Max(U46F18 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U46F18 Clamp(U46F18 min, U46F18 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
