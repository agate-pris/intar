...
namespace AgatePris.Intar.Fixed {
    ...
    struct I38F26 : IEquatable<I38F26>, IFormattable {
        // Consts
        // ------
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I38F26 Min(I38F26 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I38F26 Max(I38F26 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I38F26 Clamp(I38F26 min, I38F26 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
