...
namespace AgatePris.Intar.Fixed {
    ...
    struct U10F22 : IEquatable<U10F22>, IFormattable {
        // Consts
        // ------
        ...
        public static readonly U10F22 MinValue = FromBits(uint.MinValue);
        public static readonly U10F22 MaxValue = FromBits(uint.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U10F22 Clamp(U10F22 min, U10F22 max) => FromBits(Mathi.Clamp(bits, min.Bits, max.Bits));
