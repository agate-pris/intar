...
namespace AgatePris.Intar.Fixed {
    ...
    public struct U26F6 : IEquatable<U26F6>, IFormattable {
        ...
        public static readonly U26F6 MinValue = FromNum(uint.MinValue);
        public static readonly U26F6 MaxValue = FromNum(uint.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public U26F6 LosslessMul(uint other) => U26F6.FromBits(bits * other);
