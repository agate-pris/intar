...
namespace AgatePris.Intar.Fixed {
    ...
    struct I12F52 : IEquatable<I12F52>, IFormattable {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I12F52 Min(I12F52 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I12F52 Max(I12F52 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly I12F52 Clamp(I12F52 min, I12F52 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
