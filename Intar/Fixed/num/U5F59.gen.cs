...
namespace AgatePris.Intar.Fixed {
    ...
    struct U5F59 : IEquatable<U5F59>, IFormattable {
        // Consts
        // ------
        ...
        public static readonly U5F59 MinValue = FromBits(ulong.MinValue);
        public static readonly U5F59 MaxValue = FromBits(ulong.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U5F59 Clamp(U5F59 min, U5F59 max) => FromBits(Mathi.Clamp(bits, min.Bits, max.Bits));
