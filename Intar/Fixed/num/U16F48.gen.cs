...
namespace AgatePris.Intar.Fixed {
    ...
    struct U16F48 : IEquatable<U16F48>, IFormattable {
        // Consts
        // ------
        ...
        public static readonly U16F48 MinValue = FromBits(ulong.MinValue);
        public static readonly U16F48 MaxValue = FromBits(ulong.MaxValue);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U16F48 Min(U16F48 other) => FromBits(System.Math.Min(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U16F48 Max(U16F48 other) => FromBits(System.Math.Max(bits, other.Bits));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public readonly U16F48 Clamp(U16F48 min, U16F48 max) => FromBits(Math.Clamp(bits, min.Bits, max.Bits));
