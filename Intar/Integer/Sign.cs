...
namespace AgatePris.Intar.Integer {
    public static class Sign {
        ...
        [MethodImpl(AggressiveInlining)] public static bool IsNegative(this int x) => int.IsNegative(x);
        [MethodImpl(AggressiveInlining)] public static bool IsNegative(this long x) => long.IsNegative(x);
...
#else
        [MethodImpl(AggressiveInlining)] public static bool IsNegative(this int x) => x < 0;
        [MethodImpl(AggressiveInlining)] public static bool IsNegative(this long x) => x < 0;
