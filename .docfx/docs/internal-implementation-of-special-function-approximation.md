...
尚､ [最小二乗法](https://ja.wikipedia.org/wiki/%E6%9C%80%E5%B0%8F%E4%BA%8C%E4%B9%97%E6%B3%95)
...
$$
\begin{gather*}
b_{4\ 4\ 2} = 40141 & b_{4\ 4\ 4} = 7373 \\
b_{4\ 6\ 2} = 40153 & b_{4\ 6\ 4} = 7385
\end{gather*}
$$

天井関数を使うのは､ (この例では) その方が浮動小数点数演算との RMSD が小さくなるため｡ (おそらく $cos_{4\ p}$ が偶関数であることと相関がある)
