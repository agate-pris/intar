...
$$
\begin{align*}
a_{4\ 1\ 2} &= \frac{ 8 -      \pi      }{    \pi^2} & a_{4\ 1\ 4} &= \frac{16 -   4\ \pi      }{    \pi^4} \\
a_{4\ 2\ 2} &= \frac{ 3^{7/2}\ \pi - 128}{ 4\ \pi^2} & a_{4\ 2\ 4} &= \frac{ 3^{7/2}\ \pi - 144}{    \pi^4} \\
a_{4\ 3\ 2} &= \frac{ 27     \ \pi -  16}{14\ \pi^2} & a_{4\ 3\ 4} &= \frac{ 54     \ \pi - 144}{ 7\ \pi^4} \\
a_{4\ 4\ 2} &= \frac{ 49                }{10\ \pi^2} & a_{4\ 4\ 4} &= \frac{ 18                }{ 5\ \pi^4} \\
a_{4\ 5\ 2} &= \frac{160 - 3^{9/2}      }{ 4\ \pi^2} & a_{4\ 5\ 4} &= \frac{144 - 3^{9/2}      }{    \pi^4} \\
...
| p   | $a_{4\ p\ 2}$ | $a_{4\ p\ 4}$
| :-: | :------------ | :------------
| 1   | 0.4922595829549115  | 0.035249578342151415
| 2   | 0.4791921675422863  | 0.02995355435513814
| 3   | 0.498087713477496   | 0.03761163067403257
...
| p   | RMSD | 誤差の絶対値の最大値
| :-: | :--- | :-------------------
| 1 | $0.0021769446290595446$      | $0.002787073296143406$
| 2 | $0.008517450609043716$       | $0.010528572485006271$
| 3 | $0.0011148909680259859$      | $0.001856752905195394$
...
$cos_{4\ 6}$ は誤差の平均値が 0 だが､ 誤差の最大値および [ニ乗平均平方根誤差](https://ja.wikipedia.org/wiki/%E4%BA%8C%E4%B9%97%E5%B9%B3%E5%9D%87%E5%B9%B3%E6%96%B9%E6%A0%B9%E8%AA%A4%E5%B7%AE) (RMSD) が小さいのは $cos_{4\ 4}$ なので使い分ける必要がある｡

[最小二乗法](https://ja.wikipedia.org/wiki/%E6%9C%80%E5%B0%8F%E4%BA%8C%E4%B9%97%E6%B3%95)
に基づき RMSD を最小化するのが通例である｡
