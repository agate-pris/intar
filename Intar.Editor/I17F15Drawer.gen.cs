...
namespace Intar.Editor {
    ...
    public class I17F15Drawer : PropertyDrawer {
        ...
        internal static float Restore(int bits) {
            ...
            var result = System.Math.Abs((float)(bits / I17F15.OneRepr));
            var precision = 0.1f;
            ...
            for (var digit = 0; digit < 10; digit++) {
                ...
                for (var num = 0; num < 10; num++) {
                    ...
                    if (next * I17F15.OneRepr >= upperBound) {
                        result = current;
                        break;
                    }
                    ...
                    // current * I17F15.OneRepr は upperBound 以下である.
                    // よって current * I17F15.OneRepr は整数型に安全にキャストできる.
                    // キャストした値は 0 方向に丸められるため,
                    // lowerBound「以上」という条件は厳密に成立する.
                    if ((uint)(current * I17F15.OneRepr) >= lowerBound) {
            ...
            return (bits + (Mathf.Sign(bits) * 0.5f)) / I17F15.OneRepr;
        }
